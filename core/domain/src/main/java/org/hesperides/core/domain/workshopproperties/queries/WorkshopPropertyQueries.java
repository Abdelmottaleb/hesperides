...
public class WorkshopPropertyQueries extends AxonQueries {
    ...
    public Boolean workshopPropertyExists(WorkshopProperty workshopProperty) {
        return querySync(new WorkshopPropertyAlreadyExistsQuery(workshopProperty.getKey()), Boolean.class);
    }
